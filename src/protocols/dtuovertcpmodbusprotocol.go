...
type DtuOverTcpModbusProtocol struct {
...
// Encode ...
func (cc *DtuOverTcpModbusProtocol) Encode(c gnet.Conn, buf []byte) ([]byte, error) {
	result := make([]byte, 0)
...
// Decode ...
func (cc *DtuOverTcpModbusProtocol) Decode(c gnet.Conn) ([]byte, error) {
	// parse header
